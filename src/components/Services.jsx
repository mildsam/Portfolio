...
import { Server, Code, Link, BriefcaseBusiness, LifeBuoy } from 'lucide-react';

const Services = () => {
  return (
    <section id="services" className="py-20 px-6 lg:px-16 bg-white dark:bg-gray-800 transition-colors">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-2 text-textDark dark:text-white">Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative overflow-hidden p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-800/80 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-primary/5 dark:hover:shadow-purple-500/10 hover:-translate-y-2 hover:border-primary/30 dark:hover:border-purple-500/30 transition-all duration-500 group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white group-hover:text-primary dark:group-hover:text-purple-400 transition-colors">Backend Development</h3>
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                REST APIs, authentication, backend business logic and database-driven applications.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-800/80 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-accent/5 dark:hover:shadow-accent/10 hover:-translate-y-2 hover:border-accent/30 dark:hover:border-accent/30 transition-all duration-500 group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white group-hover:text-accent transition-colors">Full-Stack Development</h3>
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                Web applications using React, Node.js, Express.js and modern web technologies.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-800/80 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-primary/5 dark:hover:shadow-purple-500/10 hover:-translate-y-2 hover:border-primary/30 dark:hover:border-purple-500/30 transition-all duration-500 group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white group-hover:text-primary dark:group-hover:text-purple-400 transition-colors">API & System Integration</h3>
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                Payments, notifications, media services and third-party API integrations.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-800/80 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-accent/5 dark:hover:shadow-accent/10 hover:-translate-y-2 hover:border-accent/30 dark:hover:border-accent/30 transition-all duration-500 group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white group-hover:text-accent transition-colors">Business Applications</h3>
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                Custom software and web applications built around specific business requirements.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden p-8 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-800/80 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl hover:shadow-primary/5 dark:hover:shadow-purple-500/10 hover:-translate-y-2 hover:border-primary/30 dark:hover:border-purple-500/30 transition-all duration-500 group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-bold mb-3 dark:text-white group-hover:text-primary dark:group-hover:text-purple-400 transition-colors">Maintenance & Updates</h3>
              <p className="text-gray-500 dark:text-gray-300 text-sm leading-relaxed">
                Bug fixes, feature development and improvements to existing applications.
              </p>
            </div>
          </div>
        </div>
